...
( function ( wp ) {
	...
	var DEFAULTS = {
		...
		intro: __(
			'You have the right to withdraw from your purchase within 14 days of receiving your order. Click below to start the withdrawal process.',
			'surecart-eu-helper'
		),
		buttonLabel: __( 'Withdraw from contract here', 'surecart-eu-helper' ),
	...
	registerBlockType( 'surecart-eu-helper/right-of-withdrawal', {
		...
		edit: function ( props ) {
			...
			var blockProps = useBlockProps( {
				className:
					'sceu-row sceu-row--editor sceu-row--scheme-' + scheme + ' sceu-row--' + container,
			} );
			...
			return el(
				...
				el(
					...
					el(
						PanelBody,
						{ title: __( 'Withdrawal text', 'surecart-eu-helper' ), initialOpen: true },
					...
					el(
						PanelBody,
						{ title: __( 'Appearance', 'surecart-eu-helper' ), initialOpen: false },
						el( SelectControl, {
							key: 'colorScheme',
				...
				el(
					...
					el(
						...
						el(
							...
							el( a.headingLevel || 'h3', { className: 'sceu-row__heading' }, a.heading || DEFAULTS.heading ),
							el( 'p', { className: 'sceu-row__intro' }, a.intro || DEFAULTS.intro )
						),
						el(
							'div',
							...
							el(
								'button',
								{ type: 'button', className: 'sceu-row__trigger sceu-btn sceu-btn--primary wp-element-button', disabled: true },
