/**
 * Withdrawal Request Form — editor component.
 *
 * Server-rendered (dynamic) block: save() returns null (see index.js) and
 * render.php draws the live form. edit() shows a static preview plus the
 * text-override controls; the live form renders the same markup server-side.
 */
